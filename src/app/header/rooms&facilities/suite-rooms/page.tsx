        ...
        <article className="room">
          <div className="slider">
            <div className="swiper-container-room swiper-container-horizontal swiper-container-fade">
              ...
              >
                <Link
                  href="/image/MG_0138.png"
                  className="swiper-slide swiper-slide-prev"
                  style={{
                    backgroundImage: "url(/image/MG_0138.png)",
                    width: 1140,
                    opacity: 1,
                ...
                <Link
                  href="/image/MG_0205.png"
                  className="swiper-slide swiper-slide-active"
                  style={{
                    backgroundImage: 'url("/image/MG_0205.png")',
                    width: 1140,
                    opacity: 1,
            ...
            <div className="room-content text-center">
              ...
              <figure>
                <div
                  ...
                  style={{ height: 500 }}
                >
                  <Link href="/image/MG_0138.png" />
                  <Link href="/image/MG_0205.png" />
                  <Link href="/image/MG_0205.png" />
                </div>
              </figure>
              <p />
